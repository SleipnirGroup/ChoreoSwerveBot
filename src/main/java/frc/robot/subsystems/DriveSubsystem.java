...
public class DriveSubsystem extends SubsystemBase {
  ...
  public void periodic() {
    ...
    if (RobotBase.isSimulation()){
      var speeds = DriveConstants.kDriveKinematics.toChassisSpeeds(
        m_frontLeft.getState(),
        m_frontRight.getState(),
        m_rearLeft.getState(),
        m_rearRight.getState()
      );
      m_gyroAngle = m_gyroAngle.plus(new Rotation2d(speeds.omegaRadiansPerSecond * 0.02));
    } else {
